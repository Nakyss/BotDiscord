...
-- Table structure for table `SAY_TO`
CREATE TABLE `SAY_TO` (
  `ID_SAY_TO`     int             NOT NULL AUTO_INCREMENT,
  `AUTHOR`        bigint          NOT NULL,
  `RECEIVER`      bigint          NULL,
  `DATE`          datetime        NOT NULL,
  `MESSAGE`       varchar(2000)   NOT NULL,
  CONSTRAINT PK_SAY_TO PRIMARY KEY (`ID_SAY_TO`)
);
...
-- Indexes for table `SAY_TO`
ALTER TABLE `SAY_TO`
  ADD CONSTRAINT `FK_SAY_TO_TO_USER_auth` FOREIGN KEY (`AUTHOR`) REFERENCES `USER` (`ID_USER`);